...
class MockupProcessorApi
{
    ...
    /**
     * Operation mockupProcessorImportMockupFromUrl
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['mockupProcessorImportMockupFromUrl'] to see the possible values for this operation
     *
     * @throws \Aurigma\AssetProcessor\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function mockupProcessorImportMockupFromUrl($tenant_id = null, $import_mockup_from_url_model = null, string $contentType = self::contentTypes['mockupProcessorImportMockupFromUrl'][0])
    {
        list($response) = $this->mockupProcessorImportMockupFromUrlWithHttpInfo($tenant_id, $import_mockup_from_url_model, $contentType);
        return $response;
    }

    /**
     * Operation mockupProcessorImportMockupFromUrlWithHttpInfo
     *
     * Imports a mockup from the remote source file and saves it to the storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     */
    public function mockupProcessorImportMockupFromUrlWithHttpInfo($tenant_id = null, $import_mockup_from_url_model = null, string $contentType = self::contentTypes['mockupProcessorImportMockupFromUrl'][0])
    {
        $request = $this->mockupProcessorImportMockupFromUrlRequest($tenant_id, $import_mockup_from_url_model, $contentType);
    ...
    /**
     * Operation mockupProcessorImportMockupFromUrlAsync
     *
     * Imports a mockup from the remote source file and saves it to the storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mockupProcessorImportMockupFromUrlAsync($tenant_id = null, $import_mockup_from_url_model = null, string $contentType = self::contentTypes['mockupProcessorImportMockupFromUrl'][0])
    {
        return $this->mockupProcessorImportMockupFromUrlAsyncWithHttpInfo($tenant_id, $import_mockup_from_url_model, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation mockupProcessorImportMockupFromUrlAsyncWithHttpInfo
     *
     * Imports a mockup from the remote source file and saves it to the storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mockupProcessorImportMockupFromUrlAsyncWithHttpInfo($tenant_id = null, $import_mockup_from_url_model = null, string $contentType = self::contentTypes['mockupProcessorImportMockupFromUrl'][0])
    {
        $returnType = '\Aurigma\AssetProcessor\Model\MockupDto';
        $request = $this->mockupProcessorImportMockupFromUrlRequest($tenant_id, $import_mockup_from_url_model, $contentType);
    ...
    /**
     * Create request for operation 'mockupProcessorImportMockupFromUrl'
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportMockupFromUrlModel $import_mockup_from_url_model Parameters of the import operation. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['mockupProcessorImportMockupFromUrl'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function mockupProcessorImportMockupFromUrlRequest($tenant_id = null, $import_mockup_from_url_model = null, string $contentType = self::contentTypes['mockupProcessorImportMockupFromUrl'][0])
    {




        $resourcePath = '/api/processor/v1/mockups/import/from-url';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
