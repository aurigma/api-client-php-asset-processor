...
class FontProcessorApi
{
    ...
    /**
     * Operation fontProcessorImportFontFromUrl
     *
     * Imports font from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportFontFromUrlModel $import_font_from_url_model Import operation parameters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fontProcessorImportFontFromUrl'] to see the possible values for this operation
     *
     * @throws \Aurigma\AssetProcessor\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function fontProcessorImportFontFromUrl($tenant_id = null, $import_font_from_url_model = null, string $contentType = self::contentTypes['fontProcessorImportFontFromUrl'][0])
    {
        list($response) = $this->fontProcessorImportFontFromUrlWithHttpInfo($tenant_id, $import_font_from_url_model, $contentType);
        return $response;
    }

    /**
     * Operation fontProcessorImportFontFromUrlWithHttpInfo
     *
     * Imports font from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     */
    public function fontProcessorImportFontFromUrlWithHttpInfo($tenant_id = null, $import_font_from_url_model = null, string $contentType = self::contentTypes['fontProcessorImportFontFromUrl'][0])
    {
        $request = $this->fontProcessorImportFontFromUrlRequest($tenant_id, $import_font_from_url_model, $contentType);
    ...
    /**
     * Operation fontProcessorImportFontFromUrlAsync
     *
     * Imports font from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fontProcessorImportFontFromUrlAsync($tenant_id = null, $import_font_from_url_model = null, string $contentType = self::contentTypes['fontProcessorImportFontFromUrl'][0])
    {
        return $this->fontProcessorImportFontFromUrlAsyncWithHttpInfo($tenant_id, $import_font_from_url_model, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation fontProcessorImportFontFromUrlAsyncWithHttpInfo
     *
     * Imports font from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fontProcessorImportFontFromUrlAsyncWithHttpInfo($tenant_id = null, $import_font_from_url_model = null, string $contentType = self::contentTypes['fontProcessorImportFontFromUrl'][0])
    {
        $returnType = '\Aurigma\AssetProcessor\Model\FontDto';
        $request = $this->fontProcessorImportFontFromUrlRequest($tenant_id, $import_font_from_url_model, $contentType);
    ...
    /**
     * Create request for operation 'fontProcessorImportFontFromUrl'
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportFontFromUrlModel $import_font_from_url_model Import operation parameters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fontProcessorImportFontFromUrl'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function fontProcessorImportFontFromUrlRequest($tenant_id = null, $import_font_from_url_model = null, string $contentType = self::contentTypes['fontProcessorImportFontFromUrl'][0])
    {




        $resourcePath = '/api/processor/v1/fonts/import/from-url';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($import_font_from_url_model)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($import_font_from_url_model));
            } else {
                $httpBody = $import_font_from_url_model;
            }
