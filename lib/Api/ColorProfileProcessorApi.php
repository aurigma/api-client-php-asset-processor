...
class ColorProfileProcessorApi
{
    ...
    /**
     * Operation colorProfileProcessorImportColorProfileFromUrl
     *
     * Imports color profile from remote source and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportColorProfileFromUrlModel $import_color_profile_from_url_model Import operation parameters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['colorProfileProcessorImportColorProfileFromUrl'] to see the possible values for this operation
     *
     * @throws \Aurigma\AssetProcessor\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function colorProfileProcessorImportColorProfileFromUrl($tenant_id = null, $import_color_profile_from_url_model = null, string $contentType = self::contentTypes['colorProfileProcessorImportColorProfileFromUrl'][0])
    {
        list($response) = $this->colorProfileProcessorImportColorProfileFromUrlWithHttpInfo($tenant_id, $import_color_profile_from_url_model, $contentType);
        return $response;
    }

    /**
     * Operation colorProfileProcessorImportColorProfileFromUrlWithHttpInfo
     *
     * Imports color profile from remote source and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     */
    public function colorProfileProcessorImportColorProfileFromUrlWithHttpInfo($tenant_id = null, $import_color_profile_from_url_model = null, string $contentType = self::contentTypes['colorProfileProcessorImportColorProfileFromUrl'][0])
    {
        $request = $this->colorProfileProcessorImportColorProfileFromUrlRequest($tenant_id, $import_color_profile_from_url_model, $contentType);
    ...
    /**
     * Operation colorProfileProcessorImportColorProfileFromUrlAsync
     *
     * Imports color profile from remote source and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function colorProfileProcessorImportColorProfileFromUrlAsync($tenant_id = null, $import_color_profile_from_url_model = null, string $contentType = self::contentTypes['colorProfileProcessorImportColorProfileFromUrl'][0])
    {
        return $this->colorProfileProcessorImportColorProfileFromUrlAsyncWithHttpInfo($tenant_id, $import_color_profile_from_url_model, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation colorProfileProcessorImportColorProfileFromUrlAsyncWithHttpInfo
     *
     * Imports color profile from remote source and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function colorProfileProcessorImportColorProfileFromUrlAsyncWithHttpInfo($tenant_id = null, $import_color_profile_from_url_model = null, string $contentType = self::contentTypes['colorProfileProcessorImportColorProfileFromUrl'][0])
    {
        $returnType = '\Aurigma\AssetProcessor\Model\ColorProfileDto';
        $request = $this->colorProfileProcessorImportColorProfileFromUrlRequest($tenant_id, $import_color_profile_from_url_model, $contentType);
    ...
    /**
     * Create request for operation 'colorProfileProcessorImportColorProfileFromUrl'
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportColorProfileFromUrlModel $import_color_profile_from_url_model Import operation parameters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['colorProfileProcessorImportColorProfileFromUrl'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function colorProfileProcessorImportColorProfileFromUrlRequest($tenant_id = null, $import_color_profile_from_url_model = null, string $contentType = self::contentTypes['colorProfileProcessorImportColorProfileFromUrl'][0])
    {




        $resourcePath = '/api/processor/v1/color-profiles/import/from-url';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($import_color_profile_from_url_model)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($import_color_profile_from_url_model));
            } else {
                $httpBody = $import_color_profile_from_url_model;
            }
