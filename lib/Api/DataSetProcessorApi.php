...
class DataSetProcessorApi
{
    ...
    /**
     * Operation dataSetProcessorImportDataSetFromUrl
     *
     * Imports data set from remote source and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportDataSetFromUrlModel $import_data_set_from_url_model Import operation parameters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dataSetProcessorImportDataSetFromUrl'] to see the possible values for this operation
     *
     * @throws \Aurigma\AssetProcessor\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function dataSetProcessorImportDataSetFromUrl($tenant_id = null, $import_data_set_from_url_model = null, string $contentType = self::contentTypes['dataSetProcessorImportDataSetFromUrl'][0])
    {
        list($response) = $this->dataSetProcessorImportDataSetFromUrlWithHttpInfo($tenant_id, $import_data_set_from_url_model, $contentType);
        return $response;
    }

    /**
     * Operation dataSetProcessorImportDataSetFromUrlWithHttpInfo
     *
     * Imports data set from remote source and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     */
    public function dataSetProcessorImportDataSetFromUrlWithHttpInfo($tenant_id = null, $import_data_set_from_url_model = null, string $contentType = self::contentTypes['dataSetProcessorImportDataSetFromUrl'][0])
    {
        $request = $this->dataSetProcessorImportDataSetFromUrlRequest($tenant_id, $import_data_set_from_url_model, $contentType);
    ...
    /**
     * Operation dataSetProcessorImportDataSetFromUrlAsync
     *
     * Imports data set from remote source and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataSetProcessorImportDataSetFromUrlAsync($tenant_id = null, $import_data_set_from_url_model = null, string $contentType = self::contentTypes['dataSetProcessorImportDataSetFromUrl'][0])
    {
        return $this->dataSetProcessorImportDataSetFromUrlAsyncWithHttpInfo($tenant_id, $import_data_set_from_url_model, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation dataSetProcessorImportDataSetFromUrlAsyncWithHttpInfo
     *
     * Imports data set from remote source and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataSetProcessorImportDataSetFromUrlAsyncWithHttpInfo($tenant_id = null, $import_data_set_from_url_model = null, string $contentType = self::contentTypes['dataSetProcessorImportDataSetFromUrl'][0])
    {
        $returnType = '\Aurigma\AssetProcessor\Model\DataSetDto';
        $request = $this->dataSetProcessorImportDataSetFromUrlRequest($tenant_id, $import_data_set_from_url_model, $contentType);
    ...
    /**
     * Create request for operation 'dataSetProcessorImportDataSetFromUrl'
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportDataSetFromUrlModel $import_data_set_from_url_model Import operation parameters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dataSetProcessorImportDataSetFromUrl'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function dataSetProcessorImportDataSetFromUrlRequest($tenant_id = null, $import_data_set_from_url_model = null, string $contentType = self::contentTypes['dataSetProcessorImportDataSetFromUrl'][0])
    {




        $resourcePath = '/api/processor/v1/data-sets/import/from-url';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($import_data_set_from_url_model)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($import_data_set_from_url_model));
            } else {
                $httpBody = $import_data_set_from_url_model;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
