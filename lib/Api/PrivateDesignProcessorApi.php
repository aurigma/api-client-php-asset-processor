...
class PrivateDesignProcessorApi
{
     ...
     * @param  bool $preview_settings_visualize_print_areas Flag that indicates if design print areas borders should be visualized. (optional)
     ...
     */
    public function privateDesignProcessorImportDesign($source_file, $tenant_id = null, $owner_id = null, $design_params_name = null, $design_params_path = null, $design_params_custom_fields = null, $preview_settings_make_preview = null, $preview_settings_namespace = null, $preview_settings_name = null, $preview_settings_width = null, $preview_settings_height = null, $preview_settings_stub = null, $preview_settings_visualize_print_areas = null, $preview_settings_format = null, $marker_shortcuts_file = null, string $contentType = self::contentTypes['privateDesignProcessorImportDesign'][0])
    {
        list($response) = $this->privateDesignProcessorImportDesignWithHttpInfo($source_file, $tenant_id, $owner_id, $design_params_name, $design_params_path, $design_params_custom_fields, $preview_settings_make_preview, $preview_settings_namespace, $preview_settings_name, $preview_settings_width, $preview_settings_height, $preview_settings_stub, $preview_settings_visualize_print_areas, $preview_settings_format, $marker_shortcuts_file, $contentType);
        return $response;
    }
    ...
    public function privateDesignProcessorImportDesignRequest($source_file, $tenant_id = null, $owner_id = null, $design_params_name = null, $design_params_path = null, $design_params_custom_fields = null, $preview_settings_make_preview = null, $preview_settings_namespace = null, $preview_settings_name = null, $preview_settings_width = null, $preview_settings_height = null, $preview_settings_stub = null, $preview_settings_visualize_print_areas = null, $preview_settings_format = null, $marker_shortcuts_file = null, string $contentType = self::contentTypes['privateDesignProcessorImportDesign'][0])
    {
        ...
        // form params
        if ($preview_settings_visualize_print_areas !== null) {
            $formParams['previewSettings.visualizePrintAreas'] = ObjectSerializer::toFormValue($preview_settings_visualize_print_areas);
        }
        // form params
    ...
    /**
     * Operation privateDesignProcessorImportDesignFromUrl
     *
     * Imports design from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  string $owner_id owner_id (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportDesignFromUrlModel $import_design_from_url_model Import operation parameters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['privateDesignProcessorImportDesignFromUrl'] to see the possible values for this operation
     *
     * @throws \Aurigma\AssetProcessor\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function privateDesignProcessorImportDesignFromUrl($tenant_id = null, $owner_id = null, $import_design_from_url_model = null, string $contentType = self::contentTypes['privateDesignProcessorImportDesignFromUrl'][0])
    {
        list($response) = $this->privateDesignProcessorImportDesignFromUrlWithHttpInfo($tenant_id, $owner_id, $import_design_from_url_model, $contentType);
        return $response;
    }

    /**
     * Operation privateDesignProcessorImportDesignFromUrlWithHttpInfo
     *
     * Imports design from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     */
    public function privateDesignProcessorImportDesignFromUrlWithHttpInfo($tenant_id = null, $owner_id = null, $import_design_from_url_model = null, string $contentType = self::contentTypes['privateDesignProcessorImportDesignFromUrl'][0])
    {
        $request = $this->privateDesignProcessorImportDesignFromUrlRequest($tenant_id, $owner_id, $import_design_from_url_model, $contentType);
    ...
    /**
     * Operation privateDesignProcessorImportDesignFromUrlAsync
     *
     * Imports design from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function privateDesignProcessorImportDesignFromUrlAsync($tenant_id = null, $owner_id = null, $import_design_from_url_model = null, string $contentType = self::contentTypes['privateDesignProcessorImportDesignFromUrl'][0])
    {
        return $this->privateDesignProcessorImportDesignFromUrlAsyncWithHttpInfo($tenant_id, $owner_id, $import_design_from_url_model, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation privateDesignProcessorImportDesignFromUrlAsyncWithHttpInfo
     *
     * Imports design from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function privateDesignProcessorImportDesignFromUrlAsyncWithHttpInfo($tenant_id = null, $owner_id = null, $import_design_from_url_model = null, string $contentType = self::contentTypes['privateDesignProcessorImportDesignFromUrl'][0])
    {
        $returnType = '\Aurigma\AssetProcessor\Model\DesignDto';
        $request = $this->privateDesignProcessorImportDesignFromUrlRequest($tenant_id, $owner_id, $import_design_from_url_model, $contentType);
    ...
    /**
     * Create request for operation 'privateDesignProcessorImportDesignFromUrl'
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  string $owner_id (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportDesignFromUrlModel $import_design_from_url_model Import operation parameters. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function privateDesignProcessorImportDesignFromUrlRequest($tenant_id = null, $owner_id = null, $import_design_from_url_model = null, string $contentType = self::contentTypes['privateDesignProcessorImportDesignFromUrl'][0])
    {
        ...
        $resourcePath = '/api/processor/v1/private-designs/import/from-url';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($import_design_from_url_model)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($import_design_from_url_model));
            } else {
                $httpBody = $import_design_from_url_model;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  bool $visualize_print_areas Flag that indicates if design print areas borders should be visualized. (optional)
     ...
     * @return \SplFileObject|\Aurigma\AssetProcessor\Model\ProblemDetails
     */
    public function privateDesignProcessorPreparePreview($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreview'][0])
    {
        list($response) = $this->privateDesignProcessorPreparePreviewWithHttpInfo($id, $namespace, $name, $width, $height, $surface_index, $stub, $visualize_print_areas, $format, $force, $tenant_id, $owner_id, $contentType);
        return $response;
    }
     ...
     * @return array of \SplFileObject|\Aurigma\AssetProcessor\Model\ProblemDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function privateDesignProcessorPreparePreviewWithHttpInfo($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreview'][0])
    {
        $request = $this->privateDesignProcessorPreparePreviewRequest($id, $namespace, $name, $width, $height, $surface_index, $stub, $visualize_print_areas, $format, $force, $tenant_id, $owner_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function privateDesignProcessorPreparePreviewAsync($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreview'][0])
    {
        return $this->privateDesignProcessorPreparePreviewAsyncWithHttpInfo($id, $namespace, $name, $width, $height, $surface_index, $stub, $visualize_print_areas, $format, $force, $tenant_id, $owner_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function privateDesignProcessorPreparePreviewAsyncWithHttpInfo($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreview'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->privateDesignProcessorPreparePreviewRequest($id, $namespace, $name, $width, $height, $surface_index, $stub, $visualize_print_areas, $format, $force, $tenant_id, $owner_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function privateDesignProcessorPreparePreviewRequest($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreview'][0])
    {
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $visualize_print_areas,
            'visualizePrintAreas', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     */
    public function privateDesignProcessorPreparePreviewUrl($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreviewUrl'][0])
    {
        list($response) = $this->privateDesignProcessorPreparePreviewUrlWithHttpInfo($id, $namespace, $name, $width, $height, $surface_index, $stub, $visualize_print_areas, $format, $force, $tenant_id, $owner_id, $contentType);
        return $response;
    }
     ...
     */
    public function privateDesignProcessorPreparePreviewUrlWithHttpInfo($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreviewUrl'][0])
    {
        $request = $this->privateDesignProcessorPreparePreviewUrlRequest($id, $namespace, $name, $width, $height, $surface_index, $stub, $visualize_print_areas, $format, $force, $tenant_id, $owner_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function privateDesignProcessorPreparePreviewUrlAsync($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreviewUrl'][0])
    {
        return $this->privateDesignProcessorPreparePreviewUrlAsyncWithHttpInfo($id, $namespace, $name, $width, $height, $surface_index, $stub, $visualize_print_areas, $format, $force, $tenant_id, $owner_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function privateDesignProcessorPreparePreviewUrlAsyncWithHttpInfo($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreviewUrl'][0])
    {
        $returnType = 'string';
        $request = $this->privateDesignProcessorPreparePreviewUrlRequest($id, $namespace, $name, $width, $height, $surface_index, $stub, $visualize_print_areas, $format, $force, $tenant_id, $owner_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function privateDesignProcessorPreparePreviewUrlRequest($id, $namespace, $name, $width, $height, $surface_index = null, $stub = null, $visualize_print_areas = null, $format = null, $force = false, $tenant_id = null, $owner_id = null, string $contentType = self::contentTypes['privateDesignProcessorPreparePreviewUrl'][0])
    {
