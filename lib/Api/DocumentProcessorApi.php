...
class DocumentProcessorApi
{
    ...
    /**
     * Operation documentProcessorImportDocumentFromUrl
     *
     * Imports a document from the remote source file and saves it to the storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportDocumentFromUrlModel $import_document_from_url_model Parameters of the import operation. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['documentProcessorImportDocumentFromUrl'] to see the possible values for this operation
     *
     * @throws \Aurigma\AssetProcessor\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Aurigma\AssetProcessor\Model\DocumentDto|\Aurigma\AssetProcessor\Model\ProblemDetails|\Aurigma\AssetProcessor\Model\DocumentImportConflictDto
     */
    public function documentProcessorImportDocumentFromUrl($tenant_id = null, $import_document_from_url_model = null, string $contentType = self::contentTypes['documentProcessorImportDocumentFromUrl'][0])
    {
        list($response) = $this->documentProcessorImportDocumentFromUrlWithHttpInfo($tenant_id, $import_document_from_url_model, $contentType);
        return $response;
    }

    /**
     * Operation documentProcessorImportDocumentFromUrlWithHttpInfo
     *
     * Imports a document from the remote source file and saves it to the storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @throws \Aurigma\AssetProcessor\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Aurigma\AssetProcessor\Model\DocumentDto|\Aurigma\AssetProcessor\Model\ProblemDetails|\Aurigma\AssetProcessor\Model\DocumentImportConflictDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function documentProcessorImportDocumentFromUrlWithHttpInfo($tenant_id = null, $import_document_from_url_model = null, string $contentType = self::contentTypes['documentProcessorImportDocumentFromUrl'][0])
    {
        $request = $this->documentProcessorImportDocumentFromUrlRequest($tenant_id, $import_document_from_url_model, $contentType);
    ...
    /**
     * Operation documentProcessorImportDocumentFromUrlAsync
     *
     * Imports a document from the remote source file and saves it to the storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function documentProcessorImportDocumentFromUrlAsync($tenant_id = null, $import_document_from_url_model = null, string $contentType = self::contentTypes['documentProcessorImportDocumentFromUrl'][0])
    {
        return $this->documentProcessorImportDocumentFromUrlAsyncWithHttpInfo($tenant_id, $import_document_from_url_model, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation documentProcessorImportDocumentFromUrlAsyncWithHttpInfo
     *
     * Imports a document from the remote source file and saves it to the storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function documentProcessorImportDocumentFromUrlAsyncWithHttpInfo($tenant_id = null, $import_document_from_url_model = null, string $contentType = self::contentTypes['documentProcessorImportDocumentFromUrl'][0])
    {
        $returnType = '\Aurigma\AssetProcessor\Model\DocumentDto';
        $request = $this->documentProcessorImportDocumentFromUrlRequest($tenant_id, $import_document_from_url_model, $contentType);
    ...
    /**
     * Create request for operation 'documentProcessorImportDocumentFromUrl'
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportDocumentFromUrlModel $import_document_from_url_model Parameters of the import operation. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['documentProcessorImportDocumentFromUrl'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function documentProcessorImportDocumentFromUrlRequest($tenant_id = null, $import_document_from_url_model = null, string $contentType = self::contentTypes['documentProcessorImportDocumentFromUrl'][0])
    {




        $resourcePath = '/api/processor/v1/documents/import/from-url';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($import_document_from_url_model)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($import_document_from_url_model));
            } else {
                $httpBody = $import_document_from_url_model;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
