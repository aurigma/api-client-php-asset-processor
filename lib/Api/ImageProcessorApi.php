...
class ImageProcessorApi
{
    ...
    /**
     * Operation imageProcessorImportImageFromUrl
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['imageProcessorImportImageFromUrl'] to see the possible values for this operation
     *
     * @throws \Aurigma\AssetProcessor\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function imageProcessorImportImageFromUrl($tenant_id = null, $import_image_from_url_model = null, string $contentType = self::contentTypes['imageProcessorImportImageFromUrl'][0])
    {
        list($response) = $this->imageProcessorImportImageFromUrlWithHttpInfo($tenant_id, $import_image_from_url_model, $contentType);
        return $response;
    }

    /**
     * Operation imageProcessorImportImageFromUrlWithHttpInfo
     *
     * Imports image from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     */
    public function imageProcessorImportImageFromUrlWithHttpInfo($tenant_id = null, $import_image_from_url_model = null, string $contentType = self::contentTypes['imageProcessorImportImageFromUrl'][0])
    {
        $request = $this->imageProcessorImportImageFromUrlRequest($tenant_id, $import_image_from_url_model, $contentType);
    ...
    /**
     * Operation imageProcessorImportImageFromUrlAsync
     *
     * Imports image from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageProcessorImportImageFromUrlAsync($tenant_id = null, $import_image_from_url_model = null, string $contentType = self::contentTypes['imageProcessorImportImageFromUrl'][0])
    {
        return $this->imageProcessorImportImageFromUrlAsyncWithHttpInfo($tenant_id, $import_image_from_url_model, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation imageProcessorImportImageFromUrlAsyncWithHttpInfo
     *
     * Imports image from remote source file and saves it to storage.
     *
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageProcessorImportImageFromUrlAsyncWithHttpInfo($tenant_id = null, $import_image_from_url_model = null, string $contentType = self::contentTypes['imageProcessorImportImageFromUrl'][0])
    {
        $returnType = '\Aurigma\AssetProcessor\Model\ImageDto';
        $request = $this->imageProcessorImportImageFromUrlRequest($tenant_id, $import_image_from_url_model, $contentType);
    ...
    /**
     * Create request for operation 'imageProcessorImportImageFromUrl'
     *
     * @param  int $tenant_id Tenant ID. (optional)
     * @param  \Aurigma\AssetProcessor\Model\ImportImageFromUrlModel $import_image_from_url_model Import operation parameters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['imageProcessorImportImageFromUrl'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageProcessorImportImageFromUrlRequest($tenant_id = null, $import_image_from_url_model = null, string $contentType = self::contentTypes['imageProcessorImportImageFromUrl'][0])
    {




        $resourcePath = '/api/processor/v1/images/import/from-url';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
