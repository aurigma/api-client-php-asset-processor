...
/**
 * ImportMockupFromUrlModel Class Doc Comment
 *
 * @category Class
 * @description Import mockup from web source operation parameters.
 * @package  Aurigma\AssetProcessor
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ImportMockupFromUrlModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportMockupFromUrlModel';
    ...
    protected static $openAPITypes = [
        ...
        'preview_settings' => '\Aurigma\AssetProcessor\Model\ImportMockupFromUrlModelPreviewSettings',
        'type' => '\Aurigma\AssetProcessor\Model\ImportMockupType',
        'source_url' => 'string',
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Mockup name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/[^\/:*?\"<>|]*/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling ImportMockupFromUrlModel., must conform to the pattern /[^\/:*?\"<>|]*/.");
        }
     ...
     * Sets path
     *
     * @param string|null $path Mockup location (folder path).
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param array<string,mixed>|null $custom_fields Mockup custom attributes.
     *
     * @return self
     */
     ...
     *
     * @return \Aurigma\AssetProcessor\Model\ImportMockupFromUrlModelPreviewSettings|null
     */
     ...
     *
     * @param \Aurigma\AssetProcessor\Model\ImportMockupFromUrlModelPreviewSettings|null $preview_settings preview_settings
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \Aurigma\AssetProcessor\Model\ImportMockupType|null
     */
     ...
     * Sets type
     *
     * @param \Aurigma\AssetProcessor\Model\ImportMockupType|null $type Mockup type.
     *
     * @return self
     */
     ...
     * Sets source_url
     *
     * @param string|null $source_url Mockup source file URL.
     *
     * @return self
     */
     ...
     *
     * @param array<string,string>|null $request_headers Headers that will be used to download remote mockup by URL.  For example, `Authorization` header can be placed here to provide access to mockups.
     *
     * @return self
     */
