...
/**
 * ImportFontFromUrlModel Class Doc Comment
 *
 * @category Class
 * @description Import font from web source operation parameters.
 * @package  Aurigma\AssetProcessor
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ImportFontFromUrlModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportFontFromUrlModel';
    ...
    protected static $openAPITypes = [
        ...
        'preview_settings' => '\Aurigma\AssetProcessor\Model\ImportFontFromUrlModelPreviewSettings',
        'source_url' => 'string',
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Font name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/[^\/:*?\"<>|]*/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling ImportFontFromUrlModel., must conform to the pattern /[^\/:*?\"<>|]*/.");
        }
     ...
     * Sets path
     *
     * @param string|null $path Font location (folder path).
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param array<string,mixed>|null $custom_fields Font custom attributes.
     *
     * @return self
     */
     ...
     *
     * @return \Aurigma\AssetProcessor\Model\ImportFontFromUrlModelPreviewSettings|null
     */
     ...
     *
     * @param \Aurigma\AssetProcessor\Model\ImportFontFromUrlModelPreviewSettings|null $preview_settings preview_settings
     *
     * @return self
     */
     ...
     * Sets source_url
     *
     * @param string|null $source_url Font source file URL.
     *
     * @return self
     */
     ...
     *
     * @param array<string,string>|null $request_headers Headers that will be used to download remote font by URL.  For example, `Authorization` header can be placed here to provide access to fonts.
     *
     * @return self
     */
