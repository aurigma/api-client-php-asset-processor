...
/**
 * ImportImageFromUrlModel Class Doc Comment
 *
 * @category Class
 * @description Import image from web source operation parameters.
 * @package  Aurigma\AssetProcessor
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ImportImageFromUrlModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportImageFromUrlModel';
    ...
    protected static $openAPITypes = [
        ...
        'preview_settings' => '\Aurigma\AssetProcessor\Model\ImportImageFromUrlModelPreviewSettings',
        'source_url' => 'string',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/[^\/:*?\"<>|]*/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling ImportImageFromUrlModel., must conform to the pattern /[^\/:*?\"<>|]*/.");
        }
     ...
     * Sets path
     *
     * @param string|null $path Image location (folder path).
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param array<string,mixed>|null $custom_fields Image custom attributes.
     *
     * @return self
     */
     ...
     *
     * @return \Aurigma\AssetProcessor\Model\ImportImageFromUrlModelPreviewSettings|null
     */
     ...
     *
     * @param \Aurigma\AssetProcessor\Model\ImportImageFromUrlModelPreviewSettings|null $preview_settings preview_settings
     *
     * @return self
     */
     ...
     * Sets source_url
     *
     * @param string|null $source_url Image source file URL.
     *
     * @return self
     */
     ...
     *
     * @param array<string,string>|null $request_headers Headers that will be used to download remote image by URL.  For example, `Authorization` header can be placed here to provide access to images.
     *
     * @return self
     */
