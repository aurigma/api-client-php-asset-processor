<?php
/**
 * ImportColorProfileFromUrlModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ImportColorProfileFromUrlModel Class Doc Comment
 *
 * @category Class
 * @description Import color profile from web source operation parameters.
 * @package  Aurigma\AssetProcessor
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ImportColorProfileFromUrlModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportColorProfileFromUrlModel';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Color profile name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/[^\/:*?\"<>|]*/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling ImportColorProfileFromUrlModel., must conform to the pattern /[^\/:*?\"<>|]*/.");
        }
     ...
     * Sets path
     *
     * @param string|null $path Color profile location (folder path).
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param array<string,mixed>|null $custom_fields Color profile custom attributes.
     *
     * @return self
     */
     ...
     * Sets source_url
     *
     * @param string|null $source_url Color profile source file URL.
     *
     * @return self
     */
     ...
     *
     * @param array<string,string>|null $request_headers Headers that will be used to download remote color profile by URL.  For example, `Authorization` header can be placed here to provide access to color profiles.
     *
     * @return self
     */
