...
/**
 * ImportDataSchemaFromUrlModel Class Doc Comment
 *
 * @category Class
 * @description Import data schema from web source operation parameters.
 * @package  Aurigma\AssetProcessor
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ImportDataSchemaFromUrlModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportDataSchemaFromUrlModel';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/[^\/:*?\"<>|]*/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling ImportDataSchemaFromUrlModel., must conform to the pattern /[^\/:*?\"<>|]*/.");
        }
     ...
     * Sets custom_fields
     *
     * @param array<string,mixed>|null $custom_fields Data schema custom attributes.
     *
     * @return self
     */
     ...
     * Sets source_url
     *
     * @param string|null $source_url Data schema source file URL.
     *
     * @return self
     */
     ...
     *
     * @param array<string,string>|null $request_headers Headers that will be used to download remote data schema by URL.  For example, `Authorization` header can be placed here to provide access to data schemas.
     *
     * @return self
     */
