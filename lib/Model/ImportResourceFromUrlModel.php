...
/**
 * ImportResourceFromUrlModel Class Doc Comment
 *
 * @category Class
 * @description Import resource from web source operation parameters.
 * @package  Aurigma\AssetProcessor
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ImportResourceFromUrlModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportResourceFromUrlModel';
    ...
    */
     ...
     * Sets custom_fields
     *
     * @param array<string,mixed>|null $custom_fields Resource custom fields.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $anonymous_access Indicates if a resource should be available by link without authorization.
     *
     * @return self
     */
     ...
     * Sets source_url
     *
     * @param string|null $source_url Resource source file URL.
     *
     * @return self
     */
     ...
     *
     * @param array<string,string>|null $request_headers Headers that will be used to download remote resource by URL.  For example, `Authorization` header can be placed here to provide access to resources.
     *
     * @return self
     */
